...
public class VisualItemStack {
  ...
  public VisualItemStack(
      Material material, String name, boolean isEnchanted, String... subMessage) {
  ...
  public VisualItemStack(
      CustomMaterial material, String name, boolean isEnchanted, String... subMessage) {
