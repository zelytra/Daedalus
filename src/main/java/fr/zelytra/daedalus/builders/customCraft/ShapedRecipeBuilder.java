...
public class ShapedRecipeBuilder {
  ...
  public ShapedRecipeBuilder(CustomMaterial material) {
    ...
    this.shapedRecipe =
        new ShapedRecipe(this.itemKey, new CustomItemStack(material, amount).getItem());
  }
  ...
  public void register() {
    ...
    CraftPattern[] craftPatterns =
        new CraftPattern(this.shapedRecipe.getShape()).getAllPossibilities();
    int count = 0;
            ...
            if (CustomItemStack.hasTag(map.getValue().getItemStack())) {
              RecipeChoice.ExactChoice item =
                  new RecipeChoice.ExactChoice(
                      new CustomItemStack(
                              CustomItemStack.getCustomMaterial(map.getValue().getItemStack()),
                              lang)
                          .getItem());
