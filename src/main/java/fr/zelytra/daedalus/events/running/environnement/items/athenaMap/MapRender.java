...
public class MapRender extends MapRenderer {
    ...
    public void render(@NotNull MapView map, @NotNull MapCanvas canvas, @NotNull Player player) {
        ...
        Vector2 matrixCoordinate = new Vector2((int) (map.getCenterX() - maze.getOrigin().getX() + 1), (int) (map.getCenterZ() - maze.getOrigin().getZ() + 1));
        ...
        Collection<Entity> entityList = new Location(Bukkit.getWorld(Daedalus.WORLD_NAME), map.getCenterX(), 100, map.getCenterZ()).getNearbyEntities(128, 255, 128);
