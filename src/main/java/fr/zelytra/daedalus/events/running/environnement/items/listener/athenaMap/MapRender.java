...
public class MapRender extends MapRenderer {
  ...
  public void render(@NotNull MapView map, @NotNull MapCanvas canvas, @NotNull Player player) {
    ...
    Vector2 matrixCoordinate =
        new Vector2(
            (int) (map.getCenterX() - maze.getOrigin().getX() + 1),
        ...
        try {
          canvas.setPixelColor(
              ...
              GridBlockEnum.getMapPalette(
                  maze.getMaze()[matrixCoordinate.x - ((canvasSize / 2) - pixelX)][
                      matrixCoordinate.z - ((canvasSize / 2) - pixelZ)]));
    ...
    Collection<Entity> entityList =
        new Location(Bukkit.getWorld(Daedalus.WORLD_NAME), map.getCenterX(), 100, map.getCenterZ())
            .getNearbyEntities(128, 255, 128);
