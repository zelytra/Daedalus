...
public enum FoodEnum {
	MUTTON(EntityType.SHEEP, Material.MUTTON, Material.COOKED_MUTTON), PORK(EntityType.PIG, Material.PORKCHOP,
			Material.COOKED_PORKCHOP), RABBIT(EntityType.RABBIT, Material.RABBIT, Material.COOKED_RABBIT), COW(
					EntityType.COW, Material.BEEF,
					Material.COOKED_BEEF), CHICKEN(EntityType.CHICKEN, Material.CHICKEN, Material.COOKED_CHICKEN);
