...
public enum BlockEnum {
  IRON_ORE(
      BlockCooldownEnum.IRON_ORE.getSeconds(),
      Material.IRON_ORE,
      new ItemStack(Material.IRON_INGOT)),
  GOLD_ORE(
      BlockCooldownEnum.GOLD_ORE.getSeconds(),
      Material.GOLD_ORE,
      new ItemStack(Material.GOLD_INGOT)),
  END_STONE(
      BlockCooldownEnum.END_STONE.getSeconds(),
      Material.END_STONE,
      new CustomItemStack(CustomMaterial.DIVINE_FRAGMENT).getItem()),
  ...
  GRAVEL(BlockCooldownEnum.SAND.getSeconds(), Material.GRAVEL, new ItemStack(Material.FLINT)),
  RED_SAND(
      BlockCooldownEnum.RED_SAND.getSeconds(), Material.RED_SAND, new ItemStack(Material.GLASS)),
  STONE(BlockCooldownEnum.STONE.getSeconds(), Material.STONE, new ItemStack(Material.COBBLESTONE)),
  OAK_LOG(
      BlockCooldownEnum.WOOD.getSeconds(), Material.OAK_LOG, new ItemStack(Material.OAK_PLANKS, 4)),
  SPRUCE_LOG(
      BlockCooldownEnum.WOOD.getSeconds(),
      Material.SPRUCE_LOG,
      new ItemStack(Material.SPRUCE_PLANKS, 4)),
  DARK_OAK_LOG(
      BlockCooldownEnum.WOOD.getSeconds(),
      Material.DARK_OAK_LOG,
      new ItemStack(Material.DARK_OAK_PLANKS, 4)),
  ACACIA_LOG(
      BlockCooldownEnum.WOOD.getSeconds(),
      Material.ACACIA_LOG,
      new ItemStack(Material.ACACIA_PLANKS, 4)),
  BIRCH_LOG(
      BlockCooldownEnum.WOOD.getSeconds(),
      Material.BIRCH_LOG,
  ...
  JUNGLE_LOG(
      BlockCooldownEnum.WOOD.getSeconds(),
      Material.JUNGLE_LOG,
      new ItemStack(Material.JUNGLE_PLANKS, 4)),
  OAK_WOOD(
      BlockCooldownEnum.WOOD.getSeconds(),
      Material.OAK_WOOD,
  ...
  JUNGLE_WOOD(
      ...
      new ItemStack(Material.JUNGLE_PLANKS, 4)),
  JUNGLE_LEAVES(
      BlockCooldownEnum.LEAVES.getSeconds(), Material.JUNGLE_LEAVES, new ItemStack(Material.APPLE)),
  OAK_LEAVES(
      BlockCooldownEnum.LEAVES.getSeconds(), Material.OAK_LEAVES, new ItemStack(Material.APPLE)),
  DARK_OAK_LEAVES(
      BlockCooldownEnum.LEAVES.getSeconds(),
      Material.DARK_OAK_LEAVES,
      new ItemStack(Material.APPLE)),
  ACACIA_LEAVES(
      BlockCooldownEnum.LEAVES.getSeconds(), Material.ACACIA_LEAVES, new ItemStack(Material.APPLE)),
  SPRUCE_LEAVES(
      BlockCooldownEnum.LEAVES.getSeconds(), Material.SPRUCE_LEAVES, new ItemStack(Material.APPLE)),
  BIRCH_LEAVES(
      BlockCooldownEnum.LEAVES.getSeconds(),
  ...
  public ItemStack getItemStack() {
    if (CustomItemStack.hasTag(itemStack))
      return new CustomItemStack(CustomItemStack.getCustomMaterial(itemStack), GameSettings.LANG)
          .getItem();
