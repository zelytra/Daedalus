...
public class ServerPingListener implements Listener {
    ...
    public void onPing(ServerListPingEvent e) {
        ...
        switch (Daedalus.getInstance().getGameManager().getState()) {
            case WAIT:
                e.setMotd("§6| §2Maze-Game §6ᒥ §8<< §6Daedalus §8>> §6ᒧ §amc-daedalus.com        §6| §7Game Status §6: §fWaiting for players...");
                break;
            case RUNNING:
                e.setMotd("§6| §2Maze-Game §6ᒥ §8<< §6Daedalus §8>> §6ᒧ §amc-daedalus.com        §6| §7Game Status §6: §fGame running ! §b§kON");
                break;
            case FINISHED:
                e.setMotd("§6| §2Maze-Game §6ᒥ §8<< §6Daedalus §8>> §6ᒧ §amc-daedalus.com        §6| §7Game Status §6: §fWaiting for §cRestart §f!");
                break;
        }
