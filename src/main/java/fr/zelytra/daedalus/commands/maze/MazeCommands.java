...
public class MazeCommands implements CommandExecutor {
  ...
  public boolean onCommand(
      @NotNull CommandSender sender, @NotNull Command cmd, @NotNull String msg, String[] args) {
    ...
    if (args.length == 2 && args[0].equalsIgnoreCase("generateGrid")) {
      ...
      Bukkit.getScheduler()
          .runTaskAsynchronously(
              ...
              () -> {
                ...
                origin.setY(
                    player.getWorld().getHighestBlockYAt((int) origin.getX(), (int) origin.getZ()));
                MazeHandler maze =
                    new MazeHandler(
                        origin,
      ...
      Bukkit.getScheduler()
          .runTaskAsynchronously(
              ...
              () -> {
                // Location origin = player.getLocation().getBlock().getLocation().clone();
                // origin.setY(player.getWorld().getHighestBlockYAt((int) origin.getX(), (int)
                // origin.getZ()) + 1);
      ...
      player.sendMessage(
          Message.getPlayerPrefixe() + "§cWrong syntax please refer to §6/maze help §ccommand.");
      return false;
    }
  }
}
