...
public class PauseCommand implements CommandExecutor {
  ...
  public boolean onCommand(
    ...
    if (!Daedalus.getInstance().getGameManager().isRunning()) {
      System.out.println(
          Message.getPlayerPrefixe() + GameSettings.LANG.textOf("command.pauseState"));
    ...
    if (Daedalus.getInstance().getGameManager().getTimeManager().isPause()) {
                      ...
                      case 5:
                        Bukkit.broadcastMessage(
                            Message.getPlayerPrefixe()
                                + GameSettings.LANG.textOf("command.pauseRestartSoon"));
                        break;
                      case 0:
                        Bukkit.broadcastMessage(
                            Message.getPlayerPrefixe()
                                + GameSettings.LANG.textOf("command.pauseResume"));
      ...
      Bukkit.broadcastMessage(
          Message.getPlayerPrefixe() + GameSettings.LANG.textOf("command.pause"));
