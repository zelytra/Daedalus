...
public class StructureManager {
  ...
  @Getter private ArrayList<Structure> generatedList;
  @Getter @Setter private HashMap<BoundingBox, Structure> structuresPosition;
  ...
  @Getter private ShrinkManager shrinkManager;
  ...
  private void randomGenerationList() {
    ...
    for (int x = 0; x < GameSettings.DUNGEONS_COUNT; x++) {
      generatedList.add(
          this.dungeons.get(ThreadLocalRandom.current().nextInt(0, this.dungeons.size())));
    }
