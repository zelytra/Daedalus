...
public enum StructureEnum {
  ...
  ARTEMIS(
      ...
      GodsEnum.ARTEMIS),
  ATHENA(
      "athenaTemple", -2, StructureType.TEMPLE, false, new BlockVector(0, -3, 0), GodsEnum.ATHENA),
  DEMETER(
      "demeterTemple",
      -2,
      StructureType.TEMPLE,
  ...
  HERMES(
      "hermesTemple", -2, StructureType.TEMPLE, false, new BlockVector(0, -3, 0), GodsEnum.HERMES),
  POSEIDON(
      "poseidonTemple",
      -2,
      StructureType.TEMPLE,
  ...
  MINOTAURE(
      ...
      StructureType.BASE,
      true,
      new BlockVector(150, 0, 150),
      new BlockVector(0, -33, 0),
      GodsEnum.MINOTAURE),

  HESPERIDES_GARDEN(
      "hesperidesGarden", -6, StructureType.HESPERIDES_GARDEN, true, new BlockVector(0, -3, 0)),
  ...
  @Getter private final StructureType type;
  @Getter private BlockVector origin;
  @Getter private final BlockVector offset;
  @Getter private GodsEnum god;
  ...
  StructureEnum(
      String name, int id, StructureType type, Boolean canBlock, BlockVector offset, GodsEnum god) {
    this.name = name;
    this.type = type;
    this.offset = offset;
    this.god = god;
