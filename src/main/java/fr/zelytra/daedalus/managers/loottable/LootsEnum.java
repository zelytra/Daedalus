...
public enum LootsEnum {
    ...
    TIER1_EFFCIENCY1(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.EFFICIENCY, 1)),
    TIER2_EFFCIENCY2(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.EFFICIENCY, 2)),
    TIER3_EFFCIENCY3(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.EFFICIENCY, 3)),

    TIER1_FEATHERFALLING1(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.FEATHER_FALLING, 1)),
    TIER2_FEATHERFALLING2(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.FEATHER_FALLING, 2)),
    TIER3_FEATHERFALLING3(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.FEATHER_FALLING, 3)),
    ...
    TIER1_FIREPROTECTION1(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.FIRE_PROTECTION, 1)),
    TIER2_FIREPROTECTION2(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.FIRE_PROTECTION, 2)),
    TIER3_FIREPROTECTION3(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.FIRE_PROTECTION, 3)),
    ...
    TIER1_SEALUCK1(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.LUCK_OF_THE_SEA, 1)),
    TIER2_SEALUCK2(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.LUCK_OF_THE_SEA, 2)),
    TIER3_SEALUCK3(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.LUCK_OF_THE_SEA, 3)),
    ...
    TIER1_PROJECTILPROTECTION1(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.PROJECTILE_PROTECTION, 1)),
    TIER2_PROJECTILPROTECTION2(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.PROJECTILE_PROTECTION, 2)),
    TIER3_PROJECTILPROTECTION3(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.PROJECTILE_PROTECTION, 3)),

    TIER1_PROTECTION1(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.PROTECTION, 1)),
    TIER2_PROTECTION2(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.PROTECTION, 2)),
    TIER3_PROTECTION3(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.PROTECTION, 3)),
    ...
    TIER1_UNBREAKING1(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.UNBREAKING, 1)),
    TIER2_UNBREAKING2(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.UNBREAKING, 2)),
    TIER3_UNBREAKING3(Utils.BookEnchantedItemStack(Material.ENCHANTED_BOOK, Enchantment.UNBREAKING, 3)),
