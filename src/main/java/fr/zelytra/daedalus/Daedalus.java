...
public final class Daedalus extends JavaPlugin {
  ...
  @Getter public static Daedalus instance;

  @Getter private GameManager gameManager;

  @Getter private StructureManager structureManager;
  ...
  public void onEnable() {
    ...
    getServer()
        .getConsoleSender()
        .sendMessage("§a   ___    ___     ____  ___    ___     __     __  __  ____§r");
    getServer()
        .getConsoleSender()
        .sendMessage("§a  / _ \\  / _ |   / __/ / _ \\  / _ |   / /    / / / / / __/§r");
    getServer()
        .getConsoleSender()
        .sendMessage("§a / // / / __ |  / _/  / // / / __ |  / /__  / /_/ / _\\ \\  §r");
    getServer()
        .getConsoleSender()
        .sendMessage("§a/____/ /_/ |_| /___/ /____/ /_/ |_| /____/  \\____/ /___/  §r");
    getServer()
        .getConsoleSender()
        .sendMessage("                                                          ");
  ...
  private void editFAWE() {
    File configLegacy =
        new File(
            Bukkit.getPluginManager().getPlugin("FastAsyncWorldEdit").getDataFolder().getPath()
                + File.separator
                + "config-legacy.yml");
